...
КРИТИЧЕСКИ ВАЖНО ДЛЯ ИДЕЙ — перед созданием любой идеи обязательно:
1. Определи доминирующий цвет товара/одежды (белый, чёрный, красный и т.д.)
2. Определи текущий фон (белый/светлый, тёмный, интерьер, улица, цветной)
3. ЗАПРЕЩЕНО предлагать белый/светлый фон если товар белый или очень светлый — цвета сольются
4. ЗАПРЕЩЕНО предлагать "студийный белый фон" если фон уже белый и чистый
5. Всегда предлагай КОНТРАСТ: тёмный/насыщенный фон для светлого товара, светлый для тёмного
6. Идея "Главная" должна учитывать реальный цвет товара и быть максимально конкретной`;
