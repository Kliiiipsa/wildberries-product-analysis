...
const AD_LABELS: Record<string, string> = {
  SEARCH_SHELVES: 'Стратегия 1: Поиск + Полки (универсальная) — целевой + охватный трафик, % выкупа ×0.93',
  ARK_MANUAL:     'Стратегия 2: Только Поиск, АРК ручная — умеренный трафик, % выкупа ×0.90',
  ARK_AUTO:       'Стратегия 2: Только Поиск, АРК единая/авто — широкий трафик, % выкупа ×0.82',
  CPC:            'Стратегия 3: CPC Поиск ± Полки (снижение ДРР) — целевой трафик, % выкупа ×1.0',
  HOURLY:         'Стратегия 5: По часам (оптимизация бюджета) — только пиковые часы, % выкупа ×0.96',
  PRK:            'Каталог (ПРК) — полки по категории, % выкупа ×0.87',
  ARK:            'АРК (авто)',
};
